    ...
    pub fn write_byte(&mut self, byte: u8) {
        match byte {
            ...
            byte => {
                ...
                // using the write method. to guarantee that the compiler will never optimize away this write.
    ...
    pub fn write_string(&mut self, s: &str) {
        for byte in s.bytes() {
            match byte {
                ...
                _ => self.write_byte(0xfe), // Use a placeholder for unsupported characters
            }
        }
    }
}
